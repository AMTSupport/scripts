...
strURL = "https://amt.com.au/downloads/Ninite/NinitePro.exe" '<=== URL to download your ninite pro executable from ***dropbox https not working***
...
End if
strCache = "" 
strUpdparm = "/updateonly /disableautoupdate /disableshortcuts /allusers /exclude teamviewer /silent /nocache " & strUpdterpt  '<== update switches
strInstallparm = "/select chrome reader /disableshortcuts /silent /allusers "
'strInstallparm = "/select chrome malwarebytes reader /disableshortcuts /silent /allusers "
