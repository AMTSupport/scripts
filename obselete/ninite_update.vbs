...
'-----------------------------------------------------------------
'Added by Phil Haddock to delete cached files
'-----------------------------------------------------------------
If objFSO.FolderExists("C:\NinitePro\NiniteDownloads\files") then
	objFSO.DeleteFile "C:\NinitePro\NiniteDownloads\files\*.*"
End If
...
WScript.Echo "Running Update: " & commandLine
