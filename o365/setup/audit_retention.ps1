...
function Local:Connect-Session {
    if (Connect-IPPSSession -ErrorAction SilentlyContinue) {
...
function Get-Policy {
    ...
    return $UnifiedAuditLogRetentionPolicy
}
...
function Set-Policy {
    $UnifiedAuditLogRetentionPolicy = Get-Policy
