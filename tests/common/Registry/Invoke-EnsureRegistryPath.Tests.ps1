Describe "Invoke-EnsureRegistryPath Tests" -Skip:(-not $IsWindows) {
    ...
    Context "Basic Functionality" {
        It "Should create registry path with HKLM root" {
            ...
            Assert-MockCalled New-Item -Exactly 2 -Scope It
        }
        ...
        It "Should handle existing registry paths" {
            ...
            Assert-MockCalled Test-Path -AtLeast 1 -Scope It
        ...
        It "Should handle nested registry paths" {
            ...
            Assert-MockCalled Test-Path -AtLeast 3 -Scope It
            Assert-MockCalled New-Item -AtLeast 3 -Scope It
        }
    }
    ...
    Context "ShouldProcess Support" {
        ...
        It "Should support Confirm parameter" {
            ...
            Assert-MockCalled New-Item -AtLeast 1 -Scope It
        }
    }
    ...
    Context "Integration with Registry Provider" {
        It "Should build correct registry paths for HKLM" {
            ...
            Assert-MockCalled Test-Path -ParameterFilter { $Path -like 'HKLM:*' }
            Assert-MockCalled New-Item -ParameterFilter { $Path -like 'HKLM:*' }
        }
        ...
        It "Should build correct registry paths for HKCU" {
            ...
            Assert-MockCalled Test-Path -ParameterFilter { $Path -like 'HKCU:*' }
            Assert-MockCalled New-Item -ParameterFilter { $Path -like 'HKCU:*' }
        }
    }
}