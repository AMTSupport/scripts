---
id: Get-VivaModuleFeatureEnablement
title: Get-VivaModuleFeatureEnablement
description: Help page for the "Get-VivaModuleFeatureEnablement" command
keywords:
  - PowerShell
  - Help
  - Documentation
...
```powershell
Get-VivaModuleFeatureEnablement -ModuleId <String> -FeatureId <String> -Identity <String> [-Detailed]
