---
id: Get-VivaModuleFeaturePolicy
title: Get-VivaModuleFeaturePolicy
description: Help page for the "Get-VivaModuleFeaturePolicy" command
keywords:
  - PowerShell
  - Help
  - Documentation
...
### FeaturePolicyWithMembers (Default)
...
```powershell
Get-VivaModuleFeaturePolicy -ModuleId <String> -FeatureId <String> [-PolicyId <String>]
 [-ResultSize <Microsoft.Exchange.Management.RestApiClient.Unlimited`1[System.UInt32]>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
